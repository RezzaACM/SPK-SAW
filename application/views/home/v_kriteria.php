           	...
           	<div class="box-body">
                ...
                <tr>
                  ...
                  <td><?php echo $row['attribute_kriteria'] ?></td>
                	<td class="text-center"><a href="<?php echo base_url('Master_kriteria/editKriteria/'.$row['id']) ?>"><span class="label label-warning">Edit</span></a>
                		<a onclick="return confirm ('Yakin Mengapus Data?')" href="<?php echo base_url('Master_kriteria/hapusKriteria/'.$row['id']) ?>"><span class="label label-danger">Hapus</span></a>
                	</td>
