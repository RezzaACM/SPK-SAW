      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url('Master_kriteria/kriteria') ?>"><i class="fa fa-circle-o"></i> Master Kriteria</a></li>
            <li><a href="<?php echo base_url('Nilai_kriteria/nilai') ?>"><i class="fa fa-circle-o"></i>Sub Kriteria</a></li>
          </ul>
        </li>
        <li class="">
